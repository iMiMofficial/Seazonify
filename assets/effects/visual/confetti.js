// Confetti Effect for Seazonify Controller
// Compatible with SeazonifyController.injectVisualEffect()
// Usage: SeazonifyController.injectVisualEffect(confettiEffect);
...
const confettiEffect = {
  ...
  author: "Seazonify",
  type: "visual",
  thumbnail: "https://cdn.jsdelivr.net/gh/iMiMofficial/Seazonify@main/assets/effects/visual/thumbnails/confetti.webp",
  version: "1.0.0",
  created: "2024-01-15",
  ...
  css: `
    ...
    .szfy-confetti-piece.swing {
      animation: szfy-confetti-fall, szfy-confetti-swing 1s ease-in-out infinite alternate;
    }
    
    @keyframes szfy-confetti-swing {
...
if (typeof window !== 'undefined' && window.SeazonifyController) {
  window.SeazonifyController.injectVisualEffect(confettiEffect);
}
