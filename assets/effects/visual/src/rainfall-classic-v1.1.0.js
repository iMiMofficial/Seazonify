...
const rainfallClassicEffect = {
    ...
    css: `
  /* Effect root to scope all DOM so controller can remove on toggle */
  .szfy-rainfall {
    position: fixed;
    top: 0;
    left: 0;
  ...
  `,
    html: `
  <div class="szfy-rainfall" id="szfy-rainfall-container"></div>
  `,
    js: `
  (function() {
    const container = document.getElementById('szfy-rainfall-container') || document.getElementById('szfy-root') || document.body;
    const rainCount = 60;
    ...
    window.szfyRainfallCleanup = function() {
      const root = document.getElementById('szfy-rainfall-container');
      if (root) {
        root.innerHTML = '';
      }
    };
