// Spring Bloom Combo Effect for Seazonify Controller
// Combines petals visual with forest sounds audio
// Usage: SeazonifyController.injectVisualEffect(springBloomVisual);
//        SeazonifyController.injectAudioEffect(springBloomAudio);

const springBloomVisual = {
...
if (typeof window !== 'undefined' && window.SeazonifyController) {
  window.SeazonifyController.injectVisualEffect(springBloomVisual);
  window.SeazonifyController.injectAudioEffect(springBloomAudio);
}

// Export for module systems
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { visual: springBloomVisual, audio: springBloomAudio };
} 