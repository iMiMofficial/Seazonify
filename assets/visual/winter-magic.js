// Winter Magic Combo Effect for Seazonify Controller
// Combines snowfall visual with fireplace audio
// Usage: SeazonifyController.injectVisualEffect(winterMagicVisual);
//        SeazonifyController.injectAudioEffect(winterMagicAudio);

const winterMagicVisual = {
  name: "Winter Magic Visual",
...
if (typeof window !== 'undefined' && window.SeazonifyController) {
  window.SeazonifyController.injectVisualEffect(winterMagicVisual);
  window.SeazonifyController.injectAudioEffect(winterMagicAudio);
}

// Export for module systems
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { visual: winterMagicVisual, audio: winterMagicAudio };
} 